...
const Contact = () => {
  return (
    <motion.div
      className="size-full p-10 max-ds:p-5"
          ...
          <label className="flex items-center">
            ...
            <div className="">
              {[
                ...
                <div key={i} className="h-fit overflow-hidden">
                  <motion.p
                    className="text-t/75 text-[10px] font-azeret uppercase flex items-center"
                    variants={textSlideAnimation}
                    initial="initial"
                    animate="animate"
                    custom={i}
        ...
        >
          {["FB", "X", "GRAM", "YT"].map((social, i) => (
            <div key={i} className="flex items-center">
              ...
              {i !== 3 && (
                <span className="text-t text-[12px] font-azeret uppercase mx-1">
                  /
                </span>
              )}
            </div>
